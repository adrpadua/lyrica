...
var rapMachine = {
	...
	["sabotage", "barrage", "arbitrage", "camoflauge", "garage", "back massage", "mirage", "montage", "collage", "applause"], ["biology", "anthropology", "apology", "astrology", "chronology", "ecology", "topology", "tautology", "criminology", "choreography"], ["note", "coat", "throat", "quote", "vote", "boat", "oat", "devote", "afloat", "footnote"], ["portable", "comfortable", "consortable", "deportable", "distortable", "exportable", "importable", "reportable", "supportable", "transportable"], ["ornament", "advertisement", "bicarbonate", "contortionist", "coordinate", "determinant", "disarmament", "encirclement", "extortionate", "impermanent", "impertinent", "invertebrate", "proportionate","subordinate", "supernatant", "unfortunate"], ["diminish", "finish", "british", "refinish", "spinach", "thinnish", "quittage", "impish", "blemish", "business"],
	[
    "ditch",
    "fitch",
    "glitch",
